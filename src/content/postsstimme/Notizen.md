...
Ich bin über den Grund zur Abgabe einer Sprechprobe für die Sprachbiometrie und das Verfahreninformiert worden.
...
Die Körperlose Stimme ist dominant, in ihrer abstrakten Form hinterfragen wir nicht ihre Authorität. Oft befindet sich hinter der Stimme eine Person und doch stellen wir uns keinen *Körper* zu ihr vor und ordnen sie damit nicht als Menschen ein. 
...
Es ist die Stimme des/der allwissenden Erzähler:in und ist damit fast *gottähnlich*.
...
Lawrence Abu Hamdans Audio-Installation _"The Freedom of Speech Itself"_ (2012) untersucht die Praxis der forensischen Sprach- und Akzentanalyse oder des "akustischen Fingerabdrucks" im historischen wie in zeitgenössischen Kontexten. 
Die Installation besteht aus zwei Hauptkomponenten: einem 34-minütigen Audio-Dokument und einer Schaumstoffskulptur. Die Schaumskulptur stellt 2 Stimmenabdrücke visuell dar, indem sie die Frequenz und Amplitude von zwei Stimmen darstellt, die das Wort "you" sagen. Diese skulpturalen Formen ähneln topografischen Karten und symbolisieren die Schnittstelle zwischen Stimme und Territorium.
