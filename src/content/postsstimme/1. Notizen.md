...
updated: Tuesday, 22/04/25, 19:14
---
...
Die 1879 festgelegten _phonetischen Mustersätze_ sind so entworfen worden, dass lautliche und grammatische Merkmale von Dialekten und Sprechgewohnheiten deutlich zum Ausdruck kommen. Es werden gezielt bestimmte Laute wie _pf_, _ts_, _kch_, _ai_, oder _ei_ untersucht
...
Inhaltlich haben die Sätze demnach keine weiter Bedeutung. 
...
Wenn sich nach dem digitalen Zeitalter die Daten auf den Speicherkarten mit der Zeit schon aufgelöst haben, werden die Aufnahmen der 4500 Lautplatten noch abrufbar sein.
...
Die Körperlose Stimme ist dominant, in ihrer abstrakten Form hinterfragen wir nicht ihre Authorität. 
...
Die Nationalsozialistische Deutsche Arbeiterpartei machte sich einen intensive Nutzung der Stimme als Propagandainstrument zu eigen.  Im Zentrum dieser Inszenierung stand die akustische Präsenz einer Stimme, die durch ihre technische Vermittlung zugleich nah wie auch fern war.
...
Die Installation besteht aus zwei Komponenten: einem 34-minütigen Audio-Dokument und einer Schaumstoffskulptur. Die Schaumskulptur visualisiert 2 Stimmenabdrücke, indem sie die Frequenz und Amplitude von zwei Stimmen abbilden, die das Wort "you" sagen. 
...
LADO ("Language Analysis for the Determination of Origin") kommt zur Verwendung bei Asylverfahen zur Bestimmung der Herkunft von Asylbewerber:innen.  

Doch Nationalität deckt sich nicht unbedingt mit Sozialisierung, in den LADO-Verfahren werden komplexe (Sprach-)Biografien außer acht gelassen und Stimme wird wie ein offizielles Dokument behandelt.
Sprache belegt nicht eindeutig Herkunft oder Identität, sondern lässt sich vielmehr als ein dynamisches Archiv persönlicher Erfahrungen beschreiben.  

## Könnt ihr nicht noch ein Augenblickchen auf uns warten, dann gehn wir mit euch.



Seit 2017 verwendet das deutsche Bundesamt für Migration und Flüchtlinge (BAMF) als einzige Behörde in Europa zur Unterstützung der Herkunftsbestimmung von Geflüchteten ein Algorithmus-gesteuertes System, den sogenannten _DIAS_ (Dialekt-Identifizierungs-Assistenten) 
...
Die Software für den Dialekt-Identifizierungs-Assistenten wurde von der US-amerikanischen Firma _Nuance Communications_ programmiert. Wie sie genau funktioniert, ist unklar - der Algorithmus ist eine Blackbox.
